...
void main()
{
    ...
    case 0:
        ...
        break;
    case 1:
        result = calcPointLight(pointLight, vNormal, vFragPos, normalize(viewerPos - vFragPos));
        break;
    case 2:
        result = calcSpotLight(spotLight, vNormal, vFragPos, normalize(viewerPos - vFragPos));
        break;
    }
